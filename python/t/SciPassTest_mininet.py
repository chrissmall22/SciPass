...
#                          config = str(os.getcwd()) + "/t/etc/InvalidConfig.xml" )
    ...
    def test_switch_init(self):
        ...
        flow = flows[0]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 4}])
        ...
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port':4, 'nw_dst': 167776512, 'nw_dst_mask': 24})
        ...
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 1}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port':4, 'nw_dst': 167776768, 'nw_dst_mask': 24})
        self.assertEquals(flow['priority'], 10)
        flow = flows[4]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 4}])
        self.assertEquals(flow['command'],"ADD")
        ...
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port':4, 'nw_dst': 167777024, 'nw_dst_mask': 24})
        self.assertEquals(flow['priority'], 10)
        flow = flows[7]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 4}])
        self.assertEquals(flow['command'],"ADD")
        ...
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 2}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port':4, 'nw_dst': 167777280, 'nw_dst_mask': 24})
        self.assertEquals(flow['priority'], 10)
        flow = flows[9]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 4}])
        self.assertEquals(flow['command'],"ADD")
        ...
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 4, 'dl_type': None})
        self.assertEquals(flow['priority'], 3)
        flow = flows[11]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 3}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 7, 'dl_type': None})
        self.assertEquals(flow['priority'], 10)
        flow = flows[12]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': 5}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 3, 'dl_type': None})
        self.assertEquals(flow['priority'], 10)
        flow = flows[13]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': '6'}, {'type': 'output', 'port': '4'}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 1, 'nw_src': 167776512, 'nw_src_mask': 24})
        self.assertEquals(flow['priority'], 500)
        flow = flows[14]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': '6'}, {'type': 'output', 'port': '5'}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 3, 'nw_dst': 167776512, 'nw_dst_mask': 24})
        self.assertEquals(flow['priority'], 500)
        flow = flows[15]
        ...
        self.assertEquals(flow['priority'], 500)
        flow = flows[17]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': '8'}, {'type': 'output', 'port': '4'}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 1, 'nw_src': 167776512, 'nw_src_mask': 24})
        self.assertEquals(flow['priority'], 500)
        flow = flows[18]
        self.assertEquals(flow['actions'],[{'type': 'output', 'port': '8'}, {'type': 'output', 'port': '5'}])
        self.assertEquals(flow['command'],"ADD")
        self.assertEquals(flow['header'], {'phys_port': 3, 'nw_dst': 167776512, 'nw_dst_mask': 24})
        self.assertEquals(flow['priority'], 500)
        flow = flows[19]
